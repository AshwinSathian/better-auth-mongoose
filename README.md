...
- The only answer offered in [discussion #1921](https://github.com/better-auth/better-auth/discussions/1921) and elsewhere is a manual workaround: reach into `mongoose.connection.getClient()` and hand the raw client to Better Auth. That sidesteps the schema/populate/validation problems rather than solving them.
